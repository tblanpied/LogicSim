...
class ComponentPickerSearch extends React.Component{
    constructor(props){
        ...
        this.searchComponent = props.searchComponent;

        this.search = this.search.bind(this);
    }

    search(e){
        this.searchComponent(e.target.value);
    }
        ...
        return(
            <div className="component_picker_search">
                <form acceptCharset="UTF-8" className="component_search_form" method="get">
                    <input onChange={this.search} className="component_search_input" type="text" placeholder="Search"></input>
