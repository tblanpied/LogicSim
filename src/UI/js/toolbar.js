  ...
  render() {
    return (
      <div className="toolbar">
        ...
        <ZoomIn className="toolbar-icon zoomin-btn toolbar_active_btn"></ZoomIn>
        ...
        <MoveHand className="toolbar-icon hand-tool-btn toolbar_active_btn toolbar_borderright"></MoveHand>
