    ...
    >
      <g className="Clock">
        <path
          ...
          d="M18 0C8.05888 0 0 8.05888 0 18V98C0 107.941 8.05888 116 18 116H138C147.941 116 156 107.941 156 98V66H177C181.418 66 185 62.4183 185 58C185 53.5817 181.418 50 177 50H156V18C156 8.05888 147.941 0 138 0H18Z"
          fill="#0A9DFF"
        />
        <rect
        ...
        <path
          className="signal"
          transform={`translate(${state.signal_offset}, 0)`}
          d="M39 54V92H28V53H29V91H38V53H49V91H58V53H69V91H78V53H89V91H98V53H109V91H118V53H129V91H138V53H149V92H148V54H139V92H128V54H119V92H108V54H99V92H88V54H79V92H68V54H59V92H48V54H39Z"
          fill="#0D24F2"
        />
        <path
          className="border"
        ...
        <g>
          <circle
            ...
            onMouseDown={(e) => {
              StartEndWire(e, id, "clock", 0, "output");
            }}
            cx="177.5"
            cy="57.5"
            r="11.5"
