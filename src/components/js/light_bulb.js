    ...
    return (
        ...
        >
            <g className="LightBulb">
                ...
                <g>
                    <circle className="IO In-0" onMouseEnter={(e) => {handleHover(e, "In-0")}} onMouseLeave={handleMouseLeave} onMouseDown={(e) => { StartEndWire(e, id, "lightbulb", 0, "input") }} cx="46" cy="172.998" r="11" fill="#FF0000" stroke="black" strokeWidth="4" />
                    {state.input_hovered === "In-0" && (
                    <g>
                        <rect x="15" y="196" width="63" height="25" fill="rgba(0, 0, 0, 0.6)" />
                        <text x="18" y="215"  fontWeight="700" letterSpacing="-2px" fontFamily='"Lucida Console", Monaco, monospace' fontSize="1.3em" fill="rgba(255, 255, 255)" className="input-name">input</text>
                    </g>
                    )}
                </g>
            </g>
