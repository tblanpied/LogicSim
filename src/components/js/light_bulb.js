      ...
      <g className="LightBulb">
        ...
        <g>
          <circle
            ...
            onMouseDown={(e) => {
              StartEndWire(e, id, "lightbulb", 0, "input");
            }}
            cx="46"
            cy="172.998"
            r="11"
