            ...
            <g opacity={this.state.opacity} onMouseDown={this._dragStart} onMouseMove={this._dragging} onMouseUp={this._dragEnd} className={"Component-andgate-" + this.id} transform={"translate(" + this.state.position.x + "," + this.state.position.y + ") rotate(" + this.state.rotation + ")"} width="206" height="106" viewBox="0 0 206 106" fill="none">
                <g className="AndGate">
                    <g opacity={this.state.selected?1:0} className="select-border">
                        ...
                        <rect className="Rectangle 1" x="35" width="83" height="106" rx="5" fill="#0A9DFF"/>
                        ...
                        <circle className="Ellipse 1" cx="118" cy="53" r="53" fill="#0A9DFF"/>
                    ...
                    <path className="Body" fillRule="evenodd" clipRule="evenodd" d="M118 3H43C40.2386 3 38 5.23858 38 8V98C38 100.761 40.2386 103 43 103H118C145.614 103 168 80.6142 168 53C168 25.3858 145.614 3 118 3Z" fill="#215FFF"/>
