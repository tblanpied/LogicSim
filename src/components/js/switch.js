    ...
    >
      <g className="Switch">
        <path
          ...
          d="M13 0C5.8203 0 0 5.8203 0 13V103C0 110.18 5.8203 116 13 116H83C90.1797 116 96 110.18 96 103V66H117C121.418 66 125 62.4183 125 58C125 53.5817 121.418 50 117 50H96V13C96 5.8203 90.1797 0 83 0H13Z"
          fill="#0A9DFF"
        />
        <rect
          className="Output-rectangle"
          x="87"
          y="53"
          width="35"
          height="10"
        ...
        <g>
          <circle
            ...
            onMouseDown={(e) => {
              StartEndWire(e, id, "switch", 0, "output");
            }}
            cx="117.5"
            cy="57.5"
            r="11.5"
        ...
        <rect
          ...
          height="75"
          rx="7.5"
          fill={state.active ? "#2BCE3B" : "#D52B2B"}
          stroke="black"
          strokeWidth="5"
        />
        <path
          className={"Button-side-top" + (state.active ? " display-none" : "")}
          onMouseDown={toggleSwitch}
          d="M28.372 26.5L25.672 35.5H70.328L67.628 26.5H28.372Z"
          fill="#B3B3B3"
          stroke="black"
        />
        <path
          className={
            "Button-side-bottom" + (state.active ? "" : " display-none")
          }
          onMouseDown={toggleSwitch}
          d="M28.372 89.5L25.672 80.5H70.328L67.628 89.5H28.372Z"
          fill="#B3B3B3"
          stroke="black"
        />
        <path
          className="Button-top-top"
          onMouseDown={toggleSwitch}
          d={
            "M28.4365 57.5L" +
            (state.active ? "28.4364" : "25.5728") +
            (state.active ? " 26.5" : " 36.5") +
            "H" +
            (state.active ? "67.5636" : "70.4272") +
            "L67.5636 57.5H28.4365Z"
          }
          fill="#E8E8E8"
          stroke="black"
        />
        <path
          className="Button-top-bottom"
          onMouseDown={toggleSwitch}
          d={
            "M28.4364 58.5L" +
            (state.active ? "25.5728" : "28.4364") +
            (state.active ? " 79.5" : " 89.5") +
            "H" +
            (state.active ? "70.4272" : "67.5636") +
            "L67.5636 58.5H28.4364Z"
          }
          fill="#E8E8E8"
          stroke="black"
        />
